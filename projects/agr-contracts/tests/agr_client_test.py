...
from smart_contracts.artifacts.agr.agr_client import (
    AgrClient,
    AgrFactory,
)
...
def agr_client(
    ...
    factory = algorand_client.client.get_typed_app_factory(
        AgrFactory, default_sender=deployer.address
    )
...
def test_says_hello(agr_client: AgrClient) -> None:
    result = agr_client.send.hello(args=("World",))
